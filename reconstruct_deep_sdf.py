...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        ...
        type=int,
        default=256,
        help="The resolution of the reconstruction marching cubes. Default 256.",
    )
    ...
    for ii, npz in enumerate(npz_filenames):
        ...
        logging.debug("loading {}".format(full_filename))
            ...
            if not save_latvec_only:
                ...
                with torch.no_grad():
                    ...
                    rec_sampling_time = deep_sdf.mesh.create_mesh(
                        decoder, latent, mesh_filename, start=start, N=args.resolution, max_batch=int(2 ** 18)
                    )
